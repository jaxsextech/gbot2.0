...
const banner = cfonts.render(('GB|1.0'), {
    font: 'chrome',
    color: 'candy',
    align: 'center',
    gradient: ["red","yellow"],
...
module.exports = { wait, simih, getBuffer,getBuffer2,getBuffer3,h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, close }
